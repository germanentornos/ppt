...
public class MoveWords{
    ...
    public static int checkWinner(String first, String second){
		...
		switch(first_i) {
		    ...
		    case 0:
		    	if(second_i == 1 || second_i == 3) return GANA;
		    	break;
		    	
		    case 1:
		    	if(second_i == 2 || second_i == 4) return GANA;
		    	break;
		    	
		    case 2:
		    	if(second_i == 3 || second_i == 0) return GANA;
		    	break;
		    	
		    case 3:
		    	if(second_i == 4 || second_i == 1) return GANA;
		    	break;
		    	
		    case 4:
		    	if(second_i == 0 || second_i == 2) return GANA;
		    	break;
